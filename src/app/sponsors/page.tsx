...
export default function Home() {
  ...
  return (
    <>
      <GlobalScrollStyles />
      <div
        className="min-h-screen overflow-y-auto bg-cover bg-center bg-no-repeat md:h-screen md:overflow-hidden"
        style={{
          backgroundImage:
            "url('https://res.cloudinary.com/dgechlqls/image/upload/v1766212699/BACKUP_SPONSORS_osnbmg.png')",
        }}
      >
        <div className="max-w-8xl font-hitchcut mx-auto h-full lg:px-10">
          {/* DESKTOP LAYOUT */}
          ...
          <div className="flex flex-col gap-8 py-12 md:hidden">
            ...
            <p className="px-4 text-center text-xl text-[#000000]">
              NIT Silchar&apos; cultural extravaganza invites you into a vibrant{" "}
              <span className="font-bold text-[#008080]">Tribal Tapestry</span>
              —a journey woven with ancient rhythms, timeless traditions, and
              stories passed through generations, where heritage comes alive and
